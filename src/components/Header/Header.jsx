...
timer:2500 
    ...
    return (
       ...
       {
        user.uid  &&      <div>
        <img src={user.photoURL ? user.photoURL : "https://st4.depositphotos.com/5989284/20550/i/600/depositphotos_205505676-stock-photo-portrait-uncertain-young-stylish-stubble.jpg"} alt="user" className='rounded-circle img-fluid ms-4'/>
